...
EPIC_NUM=$(python3 ~/.codex/scripts/sprint_lifecycle.py register-epic "$TITLE" --sprint-count ${SPRINT_COUNT:-0} --estimated-hours ${ESTIMATED_HOURS:-0} 2>&1 | grep "Registered epic" | awk '{print $3}')
