...
```bash
python3 ~/.codex/scripts/sprint_lifecycle.py start-sprint $ARGUMENTS
```
...
- Advance step: `python3 ~/.codex/scripts/sprint_lifecycle.py advance-step $ARGUMENTS`
...
2. Run `python3 ~/.codex/scripts/sprint_lifecycle.py advance-step $ARGUMENTS`
